...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex h-11 w-full items-center justify-between gap-2 rounded-lg border border-input bg-background/40 px-3.5 py-2 text-sm outline-none transition-[color,box-shadow,border-color]",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      className={cn("px-2 py-1.5 font-mono text-[0.625rem] uppercase tracking-widest text-muted-foreground", className)}
      {...props}
    />
  );
}
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        ...
        "data-[highlighted]:bg-panel-strong data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      {...props}
    >
      ...
      <span className="absolute right-2.5 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-cyan-brand" />
        </SelectPrimitive.ItemIndicator>
      </span>
    </SelectPrimitive.Item>
  );
